...
data = open('C:\\Users\\shakh\\HT.txt','r',errors = 'ignore')
raw = data.read()
raw = raw.lower()
...
flag=True
print("Hello! My name is InventtEd. How can I help you?.")
while(flag==True):
    user_response = input()
    ...
    if(user_response not in ['bye','shutdown','exit', 'quit']):
        if(user_response=='thanks' or user_response=='thank you' ):
            flag=False
            print("InventtEd : You are welcome..")
        else:
            if(welcome(user_response)!=None):
                print("InventtEd : "+welcome(user_response))
            else:
                print("InventtEd : ",end="")
